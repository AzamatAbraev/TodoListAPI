package org.todo.todolistapi.config;
...
import org.todo.todolistapi.service.JwtService;
    ...
    protected void doFilterInternal(
        ...
        if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (jwtService.isTokenValid(jwt, userDetails)) {
                UsernamePasswordAuthenticationToken oauthToken = new UsernamePasswordAuthenticationToken(
